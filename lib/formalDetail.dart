...
class formalDetail extends StatefulWidget {
  final QueryDocumentSnapshot queryDocumentSnapshot;
  formalDetail({this.queryDocumentSnapshot});

  @override
  _DetailScreenState createState() => _DetailScreenState();
}

class _DetailScreenState extends State<formalDetail> {
  String imgurl;
  String woodtype = " ";
  int quanityvalue = 1;
  int cartno = 0;
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: StreamBuilder(
            ...
            .collection("Products")
            .doc(widget.queryDocumentSnapshot['id']).snapshots(),builder: (context, snapshot) {
              if(!snapshot.hasData){
                return Center(
                  child: Text("Loading"),
                );
      ...
      child: Container(
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.queryDocumentSnapshot['name'].toUpperCase(),
              style: GoogleFonts.lato(
                textStyle: TextStyle(
