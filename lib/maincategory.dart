                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Icon(Icons.account_circle_outlined,color: Colors.black54,size:20)),
                            SizedBox(width:14),
                             GestureDetector(
                            onTap:(){
                               Navigator.of(context).push(new MaterialPageRoute(
                         ...
                         GestureDetector(
                            ...
                            child: Icon(Icons.favorite_outline_rounded,color: Colors.black54,size:20)),
                          GestureDetector(
                            onTap:(){
                            ...
                            child: Stack(children: [
                              IconButton(
                                ...
                                return cart();
                                  ...
                                  icon: Icon(Icons.shopping_cart_outlined,size:20,color: Colors.black54,)),
                              Positioned(
                                right: 7,
                                top: 7,
                                child: CircleAvatar(
